    ...
    <div style={{maxWidth:800,margin:'0 auto',padding:'24px 20px'}}>
      ...
      <div style={{display:'flex',flexDirection:'column',gap:24,fontSize:12,color:'#374151',lineHeight:1.6}}>
        ...
        <Section title="9. Report Generation">
          <p>CIOS can generate professional PDF reports for projects that have reached <strong>Completed</strong> status or <strong>Delivered</strong> phase. These reports can be shared with stakeholders or clients.</p>
          ...
          <InfoTable rows={[
            ...
            ['Admin Report','Internal team, PM, Admin','Full project KPIs: tasks, sprints, team performance, effort hours, test results, timeline, project health metrics. Branded "Generated by CIOS · Certified by 360 DMMC".'],
            ['Client Report','Client or external stakeholder','App features overview, design/visual highlights, and the 8-phase project methodology. Focused on value delivered, not internal KPIs. Branded "Generated by CIOS · Certified by 360 DMMC".'],
          ]} />
