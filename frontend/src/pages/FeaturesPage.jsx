...
const CATEGORIES = [
  ...
  },
  {
    ...
    features: [
      ...
      { title: 'Interest-Based Auto-Generation', desc: 'Configure topics/interests and CIOS auto-generates relevant test cases with match scoring.' },
    ],
  },
  {
  ...
  },
  {
    ...
    features: [
      ...
      { title: 'Client Reports', desc: 'Clean stakeholder-ready project summaries with key outcomes and delivery notes. Perfect for handoffs and audits. Every report is branded "Generated by CIOS · Certified by 360 DMMC".' },
    ],
  },
  {
  ...
  },
  {
    ...
    features: [
      ...
      { title: 'On-Premise Deployment', desc: 'Deploy CIOS on your own infrastructure. Full data control and compliance with internal policies.' },
      { title: 'Custom Fields & Workflows', desc: 'Tailor CIOS to your processes. Add custom fields to projects/tasks. Define custom phase workflows.' },
      { title: 'SLA Guarantee', desc: 'Service Level Agreement with guaranteed uptime and response times for enterprise customers.' },
      { title: 'White-Label & API Access', desc: 'Remove CIOS branding and add your own. Full API access for custom integrations and automation.' },
    ],
  },
];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 px-5">
        <div className="max-w-3xl mx-auto text-center bg-gradient-to-br from-primary-600 to-primary-800 rounded-2xl p-12 shadow-lg">
          ...
          <p className="text-primary-200 mb-8 max-w-lg mx-auto">Join teams that use CIOS to manage projects, track tasks, and deliver quality software — all in one platform.</p>
          <div className="flex items-center justify-center gap-4">
