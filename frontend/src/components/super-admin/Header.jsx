            ...
            {showNotifs && (
              <div className="absolute right-0 top-full mt-2 w-80 bg-white rounded-xl border border-surface-200 shadow-xl overflow-hidden">
                ...
                <div className="px-4 py-2.5 border-t border-surface-100 text-center">
                   <button onClick={() => { setShowNotifs(false); navigate('/super/notifications'); }} className="text-xs text-primary-600 hover:text-primary-700 font-medium bg-transparent border-none cursor-pointer">View all notifications</button>
                </div>
              </div>
            )}
          </div>
