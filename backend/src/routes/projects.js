...
router.patch('/:id/review-call', authorize('admin', 'project_manager', 'team_lead'), updateReviewCall);
router.delete('/:id/review-call', authorize('admin', 'project_manager', 'team_lead'), deleteReviewCall);
