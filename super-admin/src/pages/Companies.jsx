...
export default function Companies() {
  ...
  const columns = [
    ...
    { key: 'type', label: 'Type', render: (val) => <span className="inline-block rounded-md px-2 py-0.5 text-xs font-medium capitalize bg-surface-100 text-surface-600">{val || '—'}</span> },
    { key: 'userCount', label: 'Users' },
    { key: 'mrr', label: 'MRR', render: (val) => <span className="text-xs font-medium text-surface-600">{val || '$0'}</span> },
